...
}, _temp), (_descriptor = _applyDecoratedDescriptor(_class.prototype, "options", [mobx.observable], {
  configurable: true,
  enumerable: true,
  writable: true,
...
}), _descriptor2 = _applyDecoratedDescriptor(_class.prototype, "fieldsNames", [mobx.observable], {
  configurable: true,
  enumerable: true,
  writable: true,
  initializer: function initializer() {
...
}), _descriptor3 = _applyDecoratedDescriptor(_class.prototype, "value", [mobx.observable], {
  configurable: true,
  enumerable: true,
  writable: true,
  initializer: function initializer() {
...
}), _descriptor4 = _applyDecoratedDescriptor(_class.prototype, "placeHolder", [mobx.observable], {
  configurable: true,
  enumerable: true,
  writable: true,
  initializer: function initializer() {
...
module.exports = JBSelectBoxData;
