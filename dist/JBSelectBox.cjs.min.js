...
var JBSelectBoxData = _interopDefault(require('./JBSelectBoxData.min'));
var mobx = require('mobx');
var mobxReact = require('mobx-react');
require('./JBSelectBox.css');
...
function () {
  ...
  _createClass(JBSelectBoxService, [{
    ...
    value: function standardConfig() {
      ...
      mobx.intercept(this.props.config, 'fieldsNames', function (change) {
